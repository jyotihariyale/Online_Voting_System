<?php
session_start();
if(!isset($_SESSION['votedata']))
{
    header("location: ../");
}
$votedata = $_SESSION['votedata'];
$candidatedata = $_SESSION['candidatedata'];

if($_SESSION['votedata']['status']==0){
...
<html>
 ...
 #Profile{
    ...
    float: left;
        ...
        <table align="left">
          <tr> <td>
          <b>Name: <?php echo $votedata['name']  ?>  <td> </b> <br></br> </td></tr>

          <tr> <td>
          <b>Mobile:  <?php echo $votedata['mobile']  ?>   <td> </b> <br></br> </td></tr>
          <tr> <td>
          <b>Address:  <?php echo $votedata['address']  ?>   <td></b> <br></br> </td></tr>

          <tr> <td>
          <b>Gender:  <?php echo $votedata['gender']  ?>   <td></b> <br></br> </td></tr>
          <tr> <td>
          <b>Status:  <?php echo $status ?>   <td></b> <br></br> </td></tr>
          <tr> <td>
          <b>username:  <?php echo $votedata['username']  ?>  <td></b> <br></br> </td></tr>
        </div>
